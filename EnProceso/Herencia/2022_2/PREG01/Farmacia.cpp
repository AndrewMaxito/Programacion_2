    ...
    while (true) {
        ...
        while (archRec.get() != '\n') {
            ...
            switch (tipoMedicamneto) {
                case 0:
                    lconreceta[cantConR].cargarDatosConRec(codigoMed,especiali,
                            codigoMedicamneto, cantMedi, fecha, archMedica);
                    cantConR++;
                    break;
                case 1:
                    lsinreceta[cantSinR].cargarDatosSinRec(dni,nombreCliente,
                            codigoMedicamneto, cantMedi, fecha, archMedica);
                    cantSinR++;
                    break;
            }
